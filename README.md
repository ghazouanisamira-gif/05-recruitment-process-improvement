...
**Project Period:** December 2023 – January 2026
...
> **Key evidence:** the operating model connected workforce demand, candidate flow, sourcing channels, recruitment capability, onboarding and performance governance into one end-to-end management system. Quantitative improvement evidence is documented separately in the [Lean Six Sigma Transformation case](https://github.com/ghazouanisamira-gif/04-lean-six-sigma-transformation).

## Business Context

The project was conducted in a high-volume **Customer Contact Center / BPO environment** with approximately 250 operational employees and regular recruitment requirements.
...
## Illustrative KPI Dictionary

The following definitions are **portfolio-level examples**, not a publication of confidential source data:

| KPI | Definition | Management use |
|---|---|---|
| Recruitment lead time | Elapsed time from validated recruitment need to candidate decision / handoff, according to the agreed process boundary | Capacity and responsiveness |
| Stage conversion | Candidates progressing from one recruitment stage to the next divided by candidates entering that stage | Funnel analysis |
| Source conversion | Qualified candidates generated by a sourcing channel divided by candidates entering from that channel | Channel effectiveness |
| Onboarding completion | Share of recruited employees completing the defined onboarding sequence | Readiness and continuity |
| Early attrition | Share of employees leaving within the defined early-retention window | Recruitment quality and workforce stability |
...
The public case excludes company names, client names, candidate and employee information, proprietary tools, detailed financial assumptions and sensitive internal procedures.

The purpose is to demonstrate the **operating model, reasoning and transferable methodology**, not confidential business content.
